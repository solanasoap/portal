...
const phantomWalletPublicKey = useState<PublicKey | boolean>(
    ...
    if (route.query.data) {
      ...
      try {
        const sharedSecretDapp = nacl.box.before(
          bs58.decode(route.query.phantom_encryption_public_key!.toString()),
        ...
        phantomWalletPublicKey.value = new PublicKey(connectData.public_key);
